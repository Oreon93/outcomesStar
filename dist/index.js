...
var StarShape = function (_a) {
    ...
    return (jsxRuntime.jsx("path", { d: pathString, fill: fill, stroke: stroke, strokeWidth: strokeWidth }));
};
...
var ConcentricRings = function (_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [Array.from({ length: ringCount }, function (_, index) { return index + 1; }).map(function (ringNumber) {
                var radius = ((ringNumber + 1) / (maxScore + 1)) * outerRadius;
                return (jsxRuntime.jsxs(React.Fragment, { children: [jsxRuntime.jsx("circle", { cx: centerX, cy: centerY, r: radius, fill: "none", stroke: strokeColor, strokeWidth: "1" }), Array.from({ length: pointCount }).map(function (_, branchIndex) {
                            ...
                            return (jsxRuntime.jsxs("g", { children: [jsxRuntime.jsx("circle", { cx: textX, cy: textY, r: "10", fill: "white", stroke: strokeColor, strokeWidth: "1" }), jsxRuntime.jsx("text", { x: textX, y: textY + 3, textAnchor: "middle", fontSize: "10", fill: "#374151", fontWeight: "500", children: ringNumber })] }, "".concat(ringNumber, "-").concat(branchIndex)));
                        })] }, ringNumber));
            }), jsxRuntime.jsx("circle", { cx: centerX, cy: centerY, r: outerRadius / (maxScore + 1), fill: "white", stroke: strokeColor, strokeWidth: "2" })] }));
};
...
var DataLines = function (_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("path", { d: firstPathString, fill: "none", stroke: colors.first, strokeWidth: "2" }), firstCoords.map(function (coord, index) { return (jsxRuntime.jsx("circle", { cx: coord[0], cy: coord[1], r: "4", fill: colors.first }, "first-".concat(index))); }), jsxRuntime.jsx("path", { d: latestPathString, fill: "none", stroke: colors.latest, strokeWidth: "2" }), latestCoords.map(function (coord, index) { return (jsxRuntime.jsx("circle", { cx: coord[0], cy: coord[1], r: "4", fill: colors.latest }, "latest-".concat(index))); })] }));
};
...
var CategoryLabels = function (_a) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: categories.map(function (label, index) {
            ...
            if (currentLine)
                lines.push(currentLine);
            return (jsxRuntime.jsx("g", { children: lines.map(function (line, lineIndex) { return (jsxRuntime.jsx("text", { x: textX, y: textY + (lineIndex - (lines.length - 1) / 2) * 12, textAnchor: "middle", dominantBaseline: "middle", fontSize: fontSize, fill: textColor, fontWeight: "500", children: line }, "".concat(index, "-").concat(lineIndex))); }) }, "label-".concat(index)));
        }) }));
};

var Legend = function (_a) {
    var centerX = _a.centerX, y = _a.y, labels = _a.labels, colors = _a.colors;
    return (jsxRuntime.jsxs("g", { transform: "translate(".concat(centerX - 100, ", ").concat(y, ")"), children: [jsxRuntime.jsx("circle", { cx: "0", cy: "0", r: "5", fill: colors.first }), jsxRuntime.jsx("text", { x: "15", y: "0", dominantBaseline: "middle", fontSize: "12", fill: "#374151", children: labels.first }), jsxRuntime.jsx("circle", { cx: "165", cy: "0", r: "5", fill: colors.latest }), jsxRuntime.jsx("text", { x: "180", y: "0", dominantBaseline: "middle", fontSize: "12", fill: "#374151", children: labels.latest })] }));
};
...
var StarDiagram = function (_a) {
    ...
    return (jsxRuntime.jsx("div", { style: {
            ...
            backgroundColor: '#f9fafb'
                ...
                height: "100%",
                textAlign: 'center'
            }, children: jsxRuntime.jsxs("svg", { width: "100%", height: "100%", viewBox: "0 0 ".concat(width, " ").concat(height), style: {
                ...
                }, children: [jsxRuntime.jsx(StarShape, { centerX: centerX, centerY: centerY, outerRadius: outerRadius, innerRadius: innerRadius, pointCount: pointCount, fill: colors.star }), jsxRuntime.jsx(ConcentricRings, { centerX: centerX, centerY: centerY, outerRadius: outerRadius, pointCount: pointCount, ringCount: maxScore, strokeColor: colors.rings, maxScore: maxScore }), jsxRuntime.jsx(DataLines, { centerX: centerX, centerY: centerY, outerRadius: outerRadius, firstScores: firstScores, latestScores: latestScores, colors: {
                            first: colors.first,
                            latest: colors.latest
                        }, maxScore: maxScore }), jsxRuntime.jsx(CategoryLabels, { centerX: centerX, centerY: centerY, outerRadius: outerRadius, categories: categories }), jsxRuntime.jsx(Legend, { centerX: centerX, y: height - 30, labels: labels, colors: {
                            first: colors.first,
                            latest: colors.latest
                        } })] }) }) }));
};
...
exports.ConcentricRings = ConcentricRings;
exports.DataLines = DataLines;
exports.Legend = Legend;
exports.StarDiagram = StarDiagram;
